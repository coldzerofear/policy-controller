...
func (in *Authority) DeepCopyInto(out *Authority) {
	*out = *in
	...
	if in.GMSignature != nil {
		in, out := &in.GMSignature, &out.GMSignature
		*out = new(GMSignatureRef)
		**out = **in
	}
	return
}
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GMSignatureRef) DeepCopyInto(out *GMSignatureRef) {
	*out = *in
	out.Signer = in.Signer
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GMSignatureRef.
func (in *GMSignatureRef) DeepCopy() *GMSignatureRef {
	if in == nil {
		return nil
	}
	out := new(GMSignatureRef)
...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *GMSignerRef) DeepCopyInto(out *GMSignerRef) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new GMSignerRef.
func (in *GMSignerRef) DeepCopy() *GMSignerRef {
	if in == nil {
		return nil
	}
	out := new(GMSignerRef)
